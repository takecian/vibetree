...
interface TaskContextType {
    ...
    addRepository: (path: string, copyFiles?: string, worktreePath?: string) => Promise<Repository>;
    updateRepository: (id: string, updates: { path?: string; copyFiles?: string; worktreePath?: string }) => Promise<Repository>;
...
export function TaskProvider({ children }: TaskProviderProps) {
    ...
    const addRepository = async (path: string, copyFiles?: string, worktreePath?: string): Promise<Repository> => {
        return await addRepositoryMutation.mutateAsync({ path, copyFiles, worktreePath });
    };

    const updateRepository = async (id: string, updates: { path?: string; copyFiles?: string; worktreePath?: string }): Promise<Repository> => {
